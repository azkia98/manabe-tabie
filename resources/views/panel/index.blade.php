        ...
        <div class="col-lg-3 col-md-3 mt-2 px-1">
            <div class="bg-success text-white">
                <div class="d-flex justify-content-between p-2">
                    ...
                    <div class="d-flex align-items-center" style="font-size: 1.5rem;"><span>{{ $membersCount }}</span></div>
                </div>
                <div class="p-2">
        ...
        <div class="col-lg-3 col-md-3 mt-2 px-1">
            <div class="bg-primary text-white">
                <div class="d-flex justify-content-between p-2">
                    ...
                    <div class="d-flex align-items-center" style="font-size: 1.5rem;"><span>{{ $promoterCount }}</span></div>
                </div>
                <div class="p-2">
        ...
        <div class="col-lg-3 col-md-3 mt-2 px-1">
            <div class="bg-danger text-white">
                <div class="d-flex justify-content-between p-2">
                    ...
                    <div class="d-flex align-items-center" style="font-size: 1.5rem;"><span>{{ $protectorCount }}</span></div>
                </div>
                <div class="p-2">
        ...
        <div class="col-lg-3 col-md-3 mt-2 px-1">
            <div class="bg-success text-white">
                <div class="d-flex justify-content-between p-2">
                    ...
                    <div class="d-flex align-items-center" style="font-size: 1.5rem;"><span>{{ $studentCount }}</span></div>
                </div>
                <div class="p-2">
